...
_MAX_PASSPHRASE_LEN = const(50)  # 定义密码短语的最大长度为50个字符
...
def _entry_dialog() -> None:  # 显示密码短语输入对话框的函数
    from trezor.ui.layouts import draw_simple_text  # 导入简单文本绘制布局

    draw_simple_text(  # 绘制简单文本
        _(i18n_keys.TITLE__ENTER_PASSPHRASE),  # 标题：输入密码短语
        _(i18n_keys.SUBTITLE__ENTER_PASSPHRASE_ON_SOFTWARE),  # 副标题：在软件上输入密码短语
    )
