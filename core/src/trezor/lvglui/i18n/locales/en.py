...
translations = [
    ...
    "Set Your Wallet",
    "Create a new 12-word wallet, or restore a previously used wallet from recovery phrase backup. For other recovery phrase lengths or a multi-share wallet, tap More in the top-right to select the recovery phrase type.",
