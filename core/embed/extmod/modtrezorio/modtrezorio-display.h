 ...
 */
 ...
 ///     """
 STATIC mp_obj_t mod_trezorui_Display_homescreen_start_slide(mp_obj_t self, mp_obj_t target_y, mp_obj_t duration_ms) {
   mp_int_t y = mp_obj_get_int(target_y);
   mp_int_t duration = mp_obj_get_int(duration_ms);
 ...
 STATIC MP_DEFINE_CONST_FUN_OBJ_3(mod_trezorui_Display_homescreen_start_slide_obj,
 ...
 ///     """
 STATIC mp_obj_t mod_trezorui_Display_homescreen_set_wallpaper_obj(mp_obj_t self, mp_obj_t img_obj) {
   mp_int_t obj_ptr = mp_obj_get_int(img_obj);
   lvgl_homescreen_set_wallpaper_obj((void*)obj_ptr);
   return mp_const_none;
 }
 STATIC MP_DEFINE_CONST_FUN_OBJ_2(mod_trezorui_Display_homescreen_set_wallpaper_obj_obj,
