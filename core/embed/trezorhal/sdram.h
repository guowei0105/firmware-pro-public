...
#define FMC_SDRAM_JPEG_INPUT_DATA_BUFFER_LEN MB(1)  // 0xD0500000
...
#define FMC_SDRAM_JPEG_OUTPUT_DATA_BUFFER_LEN MB(2)  // 0xD0700000

#define FMC_SDRAM_USER_HEAP_ADDRESS            \
  (FMC_SDRAM_JPEG_OUTPUT_DATA_BUFFER_ADDRESS + \
   FMC_SDRAM_JPEG_OUTPUT_DATA_BUFFER_LEN)  // 0xD0700000
#define FMC_SDRAM_USER_HEAP_LEN MB(20)     // 0xD1B00000
